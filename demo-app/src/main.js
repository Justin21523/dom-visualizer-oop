...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/dom-visualizer-oop",
  ...
  "records": [
    ...
    {
      "id": "flow-02",
      "name": "js, TypeScript, Vite,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Review",
      "owner": "Data"
    },
    {
